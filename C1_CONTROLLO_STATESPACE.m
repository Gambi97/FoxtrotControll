...
Po = alpha*min(lambda)*[1; 0.99; 0.98; 0.97; 0.96];
disp(['Poli osservatore: ', num2str(Po'(1:end-1)])
Po_d=exp(Ts*Po); 
L = place(Az', Cz', Po_d(1:end-1))';

%% 
ctrl = SSController(Ts, K, H, u_max, L, Az, Bz, Cz, Tf);
ctrl.initialize;
